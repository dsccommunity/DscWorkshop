...
try
{
    ...
    $policyMap = @{
        ...
        'Enumerate local users on domain-joined computers'                                                                                          = @('Software\Policies\Microsoft\Windows\System', 'EnumerateLocalUsers', 'Dword', 1, 0)
        'Turn on convenience PIN sign-in'                                                                                                           = @('Software\Policies\Microsoft\Windows\System', 'AllowDomainPINLogon', 'Dword', 1, 0)
        ...
        'Enumerate administrator accounts on elevation'                                                                                             = @('Software\Microsoft\Windows\CurrentVersion\Policies\CredUI', 'EnumerateAdministrators', 'Dword', 1, 0)
        ...
        'Allow user control over installs'                                                                                                          = @('Software\Policies\Microsoft\Windows\Installer', 'EnableUserControl', 'Dword', 1, 0)
        'Always install with elevated privileges'                                                                                                   = @('Software\Policies\Microsoft\Windows\Installer', 'AlwaysInstallElevated', 'Dword', 1, 0)
        ...
        'Allow Basic authentication'                                                                                                                = @('Software\Policies\Microsoft\Windows\WinRM\Client', 'AllowBasic', 'Dword', 1, 0)
        'Allow unencrypted traffic'                                                                                                                 = @('Software\Policies\Microsoft\Windows\WinRM\Client', 'AllowUnencryptedTraffic', 'Dword', 1, 0)
