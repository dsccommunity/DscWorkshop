...
FunctionsToExport = @('By','DependingOn','Deploy','FromSource','Get-PSDeployment','Get-PSDeploymentScript','Get-PSDeploymentType','Initialize-PSDeployment','Invoke-PSDeploy','Invoke-PSDeployment','Tagged','To','WithOptions','WithPostScript','WithPreScript')
# FunctionsToExport = '*'
