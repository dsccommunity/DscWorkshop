...
$configurationData = Get-FilteredConfigurationData -Environment $environment -Datum $datum -Filter $filter -CurrentJobNumber $CurrentJobNumber -TotalJobCount $TotalJobCount
